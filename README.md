...
*ReportGenerator* converts coverage reports generated by coverlet, OpenCover, dotCover, Visual Studio, NCover, RKTracer, Cobertura, JaCoCo, Clover, gcov or lcov into human readable reports in various formats.
